...
use Drupal\study\contactInterface;
 ...
 *     "list_builder" = "Drupal\study\contactListBuilder",
 *     "views_data" = "Drupal\study\Entity\contactViewsData",
 *
 *     "form" = {
 *       "default" = "Drupal\study\Form\contactForm",
 *       "add" = "Drupal\study\Form\contactForm",
 *       "edit" = "Drupal\study\Form\contactForm",
 *       "delete" = "Drupal\study\Form\contactDeleteForm",
 *     },
 *     "access" = "Drupal\study\contactAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\study\contactHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "contact",
 ...
 *     "add-form" = "/admin/structure/contact/add",
...
class contact extends ContentEntityBase implements contactInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['Email'] = BaseFieldDefinition::create('email')
      ->setLabel(t('Email'))
      ->setDescription(t('The Email of the contact.'))
      ->setSettings(array(
        'max_length' => 50,
        'text_processing' => 0,
      ))
    ...
    $fields['telephone'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The telephone of the Contact.'))
      ->setSettings(array(
        'max_length' => 50,
        'text_processing' => 0,
      ))
