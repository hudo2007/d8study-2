...
class PageExampleController extends ControllerBase {
  ...
  public function simple() {
    $this->logFactory->get('page_example_module')->notice('Simple Page was displayed');
    $content = '<p>' . $this->t('Simple page: The quick brown fox jumps over the lazy dog.' . __FILE__) . '</p>';
    $dispatcher = \Drupal::service('event_dispatcher');

    $e = new PageEvent($content);

    $event = $dispatcher->dispatch("simple_page_load", $e);

    $newContent = $event->getContent();
